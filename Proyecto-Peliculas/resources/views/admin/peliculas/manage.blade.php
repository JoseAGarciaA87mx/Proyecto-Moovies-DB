                ...
                <div clas="main-frame">
                    <form class="form-container" action="{{route('peliculas.update', $pelicula)}}" method="POST">
                        ...
                        <div class="text-base p-2">
                            ...
                            @enderror
                            <input class="form-input" type="text" name="title" id="title" required maxlength="100" value="{{$pelicula->peli_title}}"><br>
                        </div>

                        <div class="dropdown">
                            <label class="text-white form-label" for="director" required>Director</label>
                        ...
                        <div class="text-base p-2">
                            ...
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <input class="form-input" type="text" name="studio" id="studio" required max="100" value="{{$pelicula->peli_studio}}"><br>
                        </div>
                        <div class="text-base p-2">
                            ...
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <input class="form-input" type="number" name="length" id="length" required  max="10000" value="{{$pelicula->peli_length}}"><br>
                        </div>
                        <div class="text-base p-2">
                            ...
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <input class="form-input" type="text" name="genre" id="genre" required  max="100" value="{{$pelicula->peli_genre}}"><br>
                        </div>
                        <div class="text-base p-2">
                            ...
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <input class="form-input" type="number" name="year" id="year" pattern="[0-9]+" required min="1900" max="2100" value="{{$pelicula->peli_year}}"><br>
                        </div>
                        <div class="text-base p-2">
                            <label class="form-label text-white" for="country">País de Origen:</label>
                            <input class="form-input" type="text" name="country" id="country" required  max="100" value="{{$pelicula->peli_country}}"> <br>
                        </div>
